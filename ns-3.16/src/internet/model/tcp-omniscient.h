...
#ifndef TCP_OMNISCIENT_H
#define TCP_OMNISCIENT_H

#include "tcp-socket-base.h"

namespace ns3 {

class TcpOmniscient : public TcpSocketBase
{
public:
   ...
   */
  TcpOmniscient (void);
  TcpOmniscient (const TcpOmniscient& sock);
  virtual ~TcpOmniscient (void);
...
protected:
  ...
  virtual Ptr<TcpSocketBase> Fork (void); // Call CopyObject<TcpOmniscient> to clone me
  ...
  // Realizing the omniscient prediction of cWnd
